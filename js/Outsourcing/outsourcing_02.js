window.onload = function () {
    ...
    for (var i = 0; i < 2; i++) {
        ...
        $("#order_receiving_register").append(html);
...
function make_excel_file() {
    ...
    try {
        ...
        var table = document.getElementById('order_receiving_register');
        ...
        for (var i = 0; i < tr.length; i++) {
            ...
            var params = {
                ...
                'JOB NO.': td[1].textContent,
                '입고일자': td[2].textContent,
                '거래처.': td[3].textContent,
                '품번': td[4].textContent,
                '품명': td[5].textContent,
                '발주수량': td[6].textContent,
                '합격수량': td[7].textContent
